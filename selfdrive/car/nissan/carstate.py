...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_adas, cp_cam):
    ...
    elif self.CP.carFingerprint in [CAR.LEAF_GB, CAR.LEAF_IC]:
    ...
    if self.CP.carFingerprint in [CAR.ROGUE, CAR.XTRAIL]:
      ...
      if self.CP.carFingerprint == CAR.LEAF_GB:
    ...
    if speed != 255:
      if self.CP.carFingerprint in [CAR.LEAF_GB, CAR.LEAF_IC]:
  ...
  def get_can_parser(CP):
    ...
    elif CP.carFingerprint in [CAR.LEAF_GB, CAR.LEAF_IC]:
      signals += [
